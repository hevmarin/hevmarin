...
// Temperature Sensors
//
#define TEMP_0_PIN		 1   // Analog Input//TENIA 1
#define TEMP_BED_PIN	 0   // Analog Input//0
...
//misc pins
#define	SD_DETECT_PIN	-1 // IDE ADE VALOR 3
...
#ifdef IS_ZMIB_V2
#define LCD_PINS_ENABLE 3 			// 3 ST7920_DAT_PIN	LCD_PIN_R/W		(PIN5 of LCD module)
#else
#define LCD_PINS_ENABLE 4 			// 4 ST7920_DAT_PIN	LCD_PIN_R/W		(PIN5 of LCD module)
#endif
#define LCD_PINS_D4	   	10 			//10 ST7920_CLK_PIN	LCD_PIN_ENABLE	(PIN6 of LCD module)

// Alter timing for graphical display
#define ST7920_DELAY_1 DELAY_NS(250) //CAMBIO)
#define ST7920_DELAY_2 DELAY_NS(250) //CAMBIO)
#define ST7920_DELAY_3 DELAY_NS(250) //CAMBIO)
#endif
//================================================================================
//OLED 128x64
//================================================================================

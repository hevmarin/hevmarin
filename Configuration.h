...
#define STRING_CONFIG_H_AUTHOR "(hmc)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ZMIB_V2
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 8000} //{ 3000, 3000, 100, 10000 }
 ...
 */
#define DEFAULT_ACCELERATION          2000    // X, Y, Z and E acceleration for printing moves /// zonestar 500
#define DEFAULT_RETRACT_ACCELERATION  1000    // E acceleration for retracts                   // zonestar 500
#define DEFAULT_TRAVEL_ACCELERATION   2000    // X, Y, Z acceleration for travel (non printing) moves // zonestar 1000
